    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="bg-white rounded-xl shadow-md overflow-hidden">
        <div class="bg-primary p-8 text-center text-white">
          ...
          <p>
            Register your interest for Manch Scholarship Admission Test (MSAT)
          </p>
        </div>
        ...
        <div class="p-8">
          ...
          <div v-if="submitted" class="text-center py-8">
            ...
            <p class="text-gray-500 mb-6">
              Thank you, {{ submittedName }}! We'll contact you within 24 hours.
            </p>
            <button
              @click="resetForm"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label
                  for="enq-class"
                  class="block text-sm font-medium text-gray-700 mb-1"
                  >Current Class <span class="text-red-500">*</span></label
                >
                <select
                  id="enq-class"
...
export default {
  ...
  data() {
    return {
      ...
      submittedName: "",
      formError: null,
      classes: ["8th", "9th", "10th", "11th", "12th", "NEET", "JEE"],
      courses: [
        "Foundation (8th-9th)",
        "SSC Board",
        "HSC Board",
